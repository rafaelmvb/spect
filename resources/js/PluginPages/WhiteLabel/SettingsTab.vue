...
/**
 * Monta URL para as chamadas da API white-label.
 * Usa window.location.origin (evita CORS entre localhost e 127.0.0.1)
 * e extrai o path prefix de app_url (suporte a subpasta, ex.: /spectra).
 */
