...
<template>
    <div class="space-y-6">
        ...
        <form
            v-show="activeTab !== 'update' && activeTab !== 'cron' && activeTab !== 'area-aluno' && !isPluginTab(activeTab)"
        ...
        <!-- Aba Área do Aluno -->
        <div v-show="activeTab === 'area-aluno'" class="w-full max-w-full">
            <MemberAreaSettingsPanel />
        </div>
