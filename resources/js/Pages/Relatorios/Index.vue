...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <nav class="flex flex-wrap items-center gap-1 flex-1" aria-label="Período">
                <button
            ...
            <div class="flex flex-wrap items-center gap-2 shrink-0">
                ...
                >
                    ...
                    <span class="hidden sm:inline">CSV clientes existentes</span>
                ...
                >
                    <Download class="h-4 w-4 shrink-0" aria-hidden="true" />
                    <span class="hidden sm:inline">CSV clientes engajados</span>
                    <span class="sm:hidden">CSV</span>
                </button>
                <button
                    type="button"
