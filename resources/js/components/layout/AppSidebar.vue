...
const navItems = computed(() => {
    ...
    if (canView('produtos.view')) items.push({ name: 'Alunos', href: '/alunos', icon: GraduationCap });
    ...
    if (page.props.auth?.user?.role === 'admin') {
        ...
        items.push({ name: 'Checkpoints', href: '/checkpoints', icon: ClipboardCheck });
        items.push({ name: 'Testes Clínicos', href: '/testes-clinicos', icon: ClipboardList });
        items.push({ name: 'Mapa Neuro', href: '/mapa-neuro', icon: BrainCircuit });
        items.push({ name: 'IA Contextual', href: '/ia', icon: Sparkles });
        items.push({ name: 'Comunidade', href: '/comunidade-admin', icon: Globe });
        items.push({ name: 'WhatsApp & SMS', href: '/mensagens', icon: MessageSquare });
        items.push({ name: 'Áudios', href: '/musicas', icon: Music });
        items.push({ name: 'Banners', href: '/banners', icon: ImagePlay });
        items.push({ name: 'Posts da Área', href: '/member-posts', icon: Newspaper });
        items.push({ name: 'Trilhas em Destaque', href: '/member-home-featured', icon: Star });
