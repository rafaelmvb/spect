...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        // TRUSTED_PROXIES no .env: IP ou CIDR do load balancer (ex.: "10.0.0.0/8").
        // Evitar '*' em produção para não permitir X-Forwarded-For forjado por clientes.
        $trustedProxies = env('TRUSTED_PROXIES', null);
        if ($trustedProxies !== null) {
            $middleware->trustProxies(at: $trustedProxies, headers: Request::HEADER_X_FORWARDED_FOR | Request::HEADER_X_FORWARDED_HOST | Request::HEADER_X_FORWARDED_PORT | Request::HEADER_X_FORWARDED_PROTO | Request::HEADER_X_FORWARDED_PREFIX | Request::HEADER_X_FORWARDED_AWS_ELB);
        }
        ...
        $middleware->alias([
            ...
            'member.area.resolve.from.user' => \App\Http\Middleware\ResolveMemberAreaFromUser::class,
    ...
    ->withSchedule(function (Schedule $schedule): void {
        ...
        $schedule->command('messaging-campaign:process')->everyMinute();
